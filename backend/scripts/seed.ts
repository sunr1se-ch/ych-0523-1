...
async function main() {
  ...
  await prisma.borrowRecord.createMany({
    data: [
      ...
      { cabinetId: cabinetMap.get('A04')!, residentName: '林一', bookTitle: '挪威的森林', borrowDate: daysAgo(3), expectedReturnDate: daysLater(11) },
      { cabinetId: cabinetMap.get('B01')!, residentName: '何二', bookTitle: '傲慢与偏见', borrowDate: daysAgo(4), expectedReturnDate: daysLater(10) },
      { cabinetId: cabinetMap.get('B01')!, residentName: '吕三', bookTitle: '简爱', borrowDate: daysAgo(2), expectedReturnDate: daysLater(12) },
      { cabinetId: cabinetMap.get('B01')!, residentName: '施四', bookTitle: '呼啸山庄', borrowDate: daysAgo(1), expectedReturnDate: daysLater(13) },
      { cabinetId: cabinetMap.get('B03')!, residentName: '张五', bookTitle: '老人与海', borrowDate: daysAgo(5), expectedReturnDate: daysLater(9) },
      { cabinetId: cabinetMap.get('B03')!, residentName: '孔六', bookTitle: '了不起的盖茨比', borrowDate: daysAgo(3), expectedReturnDate: daysLater(11) },
      { cabinetId: cabinetMap.get('C03')!, residentName: '曹七', bookTitle: '茶花女', borrowDate: daysAgo(2), expectedReturnDate: daysLater(12) },
      { cabinetId: cabinetMap.get('C03')!, residentName: '严八', bookTitle: '巴黎圣母院', borrowDate: daysAgo(4), expectedReturnDate: daysLater(10) },
